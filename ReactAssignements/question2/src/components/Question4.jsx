...
const Question4 = () => {
  ...
  let showRating = () => {
    if (rating <= 5 && rating > 0) {
      ...
      alert("Rating must be less than 5 and more than 0")
    }
  ...
  return (
    <div>
      <div className="container">
        <h1>Question 4 : </h1>
        <h5>Create a component which will show the rating using star images. The component should receive a
          property rating which should control number of stars to be shown</h5>

        <div className='col-ml-6'>
          <label htmlFor="rating" className='fs-1'>Enter Rating
          </label>
